...
public class StudentDaoImpl implements StudentOrderDao
{
    ...
    private static final String INSERT_ORDER = "INSERT INTO jc_student_order(" +
            ...
            ", h_building, h_extension, h_apartment, w_sur_name, w_given_name, w_patronymic, w_date_of_birth" +
            ", w_passport_series, w_passport_number, w_passport_date, w_passport_office_id, w_post_index" +
